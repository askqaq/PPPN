...
L_U_2 = Redis:sismember(Saidi.."L_U_2:Groups",UserId) 
...
return{
L_U_2All = Redis:sismember(Saidi.."L_U_2:Groups",UserId) ,
ktmall = Redis:sismember(Saidi.."ktmAll:Groups",UserId) ,
L_U_2Group = Redis:sismember(Saidi.."L_U_2:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Saidi.."SilentGroup:Group"..ChatId,UserId)
}
end
function Reply_Status(UserId,TextMsg)
local L_U_2 = LuaTele.getUser(UserId)
for Name_User in string.gmatch(L_U_2.first_name, "[^%s]+" ) do
L_U_2.first_name = Name_User
break
end
if L_U_2.username then
L_U_2username = '['..L_U_2.first_name..'](t.me/'..L_U_2.username..')'
else
L_U_2username = '['..L_U_2.first_name..'](tg://user?id='..UserId..')'
end
return {
Lock     = '\n* ✠ بواسطه ⇦ *'..L_U_2username..'\n*'..TextMsg..'\n ✠ خاصيه المسح *',
unLock   = '\n* ✠ بواسطه ⇦ *'..L_U_2username..'\n'..TextMsg,
Saidi   = '\n* ✠ العضو ⇦ *'..L_U_2username..'\n'..TextMsg,
lockKtm  = '\n* ✠ بواسطه ⇦ *'..L_U_2username..'\n*'..TextMsg..'\n ✠ خاصيه الكتم *',
lockKid  = '\n* ✠ بواسطه ⇦ *'..L_U_2username..'\n*'..TextMsg..'\n ✠ خاصيه التقييد *',
lockKick = '\n* ✠ بواسطه ⇦ *'..L_U_2username..'\n*'..TextMsg..'\n ✠ خاصيه الطرد *',
Reply    = '\n* ✠ المستخدم ⇦ *'..L_U_2username..'\n*'..TextMsg..'*'
}
end
...
if Statusrestricted(msg.chat_id,msg.sender.user_id).L_U_2All == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}),LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'L_U_2ned',0)
elseif Statusrestricted(msg.chat_id,msg.sender.user_id).ktmall == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Statusrestricted(msg.chat_id,msg.sender.user_id).L_U_2Group == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}),LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'L_U_2ned',0)
elseif Statusrestricted(msg.chat_id,msg.sender.user_id).SilentGroup == true then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if tonumber(msg.sender.user_id) == 1696907808 then
msg.Name_Controller = 'المبرمج حسون'
...
elseif Redis:sismember(Saidi.."L_U_2:Groups",msg.sender.user_id) == true then
...
local L_U_2 = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Saidi.."Welcome:Group"..msg_chat_id)
if Welcome then 
if L_U_2.username then
L_U_2username = '@'..L_U_2.username
else
L_U_2username = 'لا يوجد '
end
Welcome = Welcome:gsub('{name}',L_U_2.first_name) 
Welcome = Welcome:gsub('{user}',L_U_2username) 
Welcome = Welcome:gsub('{NameCh}',Get_Chat.title) 
return LuaTele.sendText(msg_chat_id,msg_id,Welcome,"md")  
else
return LuaTele.sendText(msg_chat_id,msg_id,' ✠ اطلق دخول ['..L_U_2.first_name..'](tg://user?id='..msg.sender.user_id..')\n ✠ نورت الكروب {'..Get_Chat.title..'}',"md")  
end
end
end
...
if type == "kick" then 
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'L_U_2ned',0), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✠ قام بالتكرار في المجموعه وتم طرده").Reply,"md",true)
end
if type == "del" then 
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'L_U_2ned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
local N = (Redis:get(Saidi.."Name:Bot") or "ليدر")
...
LuaTele.setChatMemberStatus(msg.chat_id,v,'L_U_2ned',0)
...
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'L_U_2ned',0)
end
...
{
{text = '𓄼• 𝗦𝗢𝗨𝗥𝗖𝗘 𓅛𝗟𝗘𝗔𝗗𝗘𝗥 •𓄹', url='https://t.me/LEDARQ'},
},
}
}
...
local Text = Text:gsub('#username',(L_U_2.username or 'لا يوجد')) 
local Text = Text:gsub('#name',L_U_2.first_name)
...
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Saidi..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local Texingt = Texingt:gsub('#username',(L_U_2.username or 'لا يوجد')) 
local Texingt = Texingt:gsub('#name',L_U_2.first_name)
...
if Redis:get(Saidi.."Game:L_U_2"..msg.chat_id) then
if text == Redis:get(Saidi.."Game:L_U_2"..msg.chat_id) then
Redis:del(Saidi.."Game:L_U_2"..msg.chat_id)
Redis:incrby(Saidi.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text == 'رفع نسخه ليدر' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,' ✠ تم استرجاع المجموعات من نسخه ليدر')
else
...
Redis:set(Saidi.."Sen:L_U_2:Bot",true) 
...
Redis:del(Saidi.."Left:L_U_2:Bot") 
...
Redis:set(Saidi.."Left:L_U_2:Bot",true) 
...
Redis:del(Saidi..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
if text and text:match("^@[%a%d_]+$") then
local L_U_2a = LuaTele.searchPublicChat(text)
if not L_U_2a.id then
Redis:del(Saidi..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✠ عذرا لا يوجد حساب بهاذا المعرف ","md",true)  
end
local ChannelUser = text:gsub('@','')
if L_U_2a.type.is_channel == true then
local StatusMember = LuaTele.getChatMember(L_U_2a.id,Saidi).status.luatele
...
local L_U_2 = LuaTele.getUser(Saidi)
for Name_User in string.gmatch(L_U_2.first_name, "[^%s]+" ) do
L_U_2.first_name = Name_User
break
end 
NamesBot = (Redis:get(Saidi.."Name:Bot") or "ليدر")
Groups = (Redis:scard(Saidi..'ChekBotAdd') or 0)
Users = (Redis:scard(Saidi..'Num:User:Pv') or 0)
if photo.total_count > 0 then
local L_U_2 = 'اسم بوت -› '..NamesBot..''
local Grosupsw = 'الكروبات -› '..Groups..''
local Usperos = 'المشتركين -› '..Users..''
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = L_U_2, url = 't.me/'..UserBot..'?start'}, 
},
{
...
if L_U_2.first_name then
news = " "..L_U_2.first_name.." "
else
news = " لا يوجد"
end
...
local Get_Is_Id = Get_Is_Id:gsub('#username',L_U_2username) 
...
{
{text =news,url = "https://t.me/"..L_U_2.username..""}, 
},
}
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(L_U_2_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
else
local L_U_2_ns ='\n*𓄼• ᴜѕᴇ -› '..L_U_2username..'\n𓄼• ѕᴛᴀ -›  '..RinkBot..'\n𓄼• ɪᴅ -› '..UserId..'\n𓄼• ᴍѕɢ -›  '..TotalMsg..'\n𓄼• ᴛᴘᴅʏʟᴀᴛᴋ -›  '..TotalEdit..'\n𓄼• ᴛғᴀᴘʟᴋ -›  '..TotalMsgT..'\n𓄼• ʙɪᴏ -› '..getbio(UserId)..'*'
data = {} 
data.inline_keyboard = {
...
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendMessage?chat_id=" .. msg_chat_id .. "&text=".. URL.escape(L_U_2_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
end
end
else
if Get_Is_Id then
...
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
local Get_Is_Id = Get_Is_Id:gsub('#username',(L_U_2.username or 'لا يوجد')) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text = L_U_2.first_name, url = "https://t.me/"..L_U_2.username..""}, },}}
...
return LuaTele.sendText(msg_chat_id,msg_id,L_U_2username,"md",true) 
end
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local L_U_2 = LuaTele.getUser(Message_Reply.sender.user_id)
local bain = LuaTele.getUser(msg.sender.user_id)
if L_U_2.first_name then
L_U_2iusername = '*طلب -› *['..bain.first_name..'](tg://user?id='..bain.id..')*\nالزواج من -› *['..L_U_2.first_name..'](tg://user?id='..L_U_2.id..')*\nهل العروسه مواقفه علي هذا\n*'
else
L_U_2iusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,L_U_2iusername,"md",false, false, false, false, reply_markup)
end
if text == 'صلاحياتي' then
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✠ عذرا البوت ليس ادمن في الكروب يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
...
if not Redis:sismember(Saidi.."L_U_2:Groups",L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."L_U_2:Groups")
Redis:del(Saidi.."L_U_2:Groups", L_U_2a.id)
Redis:del(Saidi.."id:L_U_2:Groups", L_U_2a.id)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم تنزيله مساعد").Reply,"md",true)  
end
end
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local L_U_2 = LuaTele.getUser(Message_Reply.sender.user_id)
if L_U_2.message == "Invalid user ID" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✠ عذرا تستطيع فقط استخدام الامر على المستخدمين ","md",true)  
end
if L_U_2 and L_U_2.type and L_U_2.type.luatele == "userTypeBot" then
...
if not Redis:sismember(Saidi.."L_U_2:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✠ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."L_U_2:Groups")
Redis:del(Saidi.."L_U_2:Groups", Message_Reply.sender.user_id)
Redis:del(Saidi.."id:L_U_2:Groups", Message_Reply.sender.user_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد في الكروب ").Saidi,"md",true)  
end
end
if TextMsg == "كلب" then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب في الكروب ").Saidi,"md",true)  
end
end
if TextMsg == "قرد" then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد في الكروب ").Saidi,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره في الكروب ").Saidi,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله في الكروب ").Saidi,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار في الكروب ").Saidi,"md",true)  
end
end
if TextMsg == "خول" then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول في الكروب ").Saidi,"md",true)  
end
end
if TextMsg == "مزه" then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه في الكروب ").Saidi,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه في الكروب ").Saidi,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني في الكروب ").Saidi,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي في الكروب ").Saidi,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين في الكروب ").Saidi,"md",true)  
end
end
end
...
local L_U_2 = LuaTele.getUser(UserId[2])
if L_U_2.luatele == "error" and L_U_2.code == 6 then
...
if not Redis:sismember(Saidi.."L_U_2:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✠ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."L_U_2:Groups")
Redis:del(Saidi.."L_U_2:Groups", UserId)
Redis:del(Saidi.."id:L_U_2:Groups", UserId)
...
if Redis:sismember(Saidi.."L_U_2:Groups",L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."L_U_2:Groups")
Redis:sadd(Saidi.."L_U_2:Groups", UserId)
Redis:set(Saidi.."id:L_U_2:Groups", UserId)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم ترقيته مساعد").Reply,"md",true)  
end
end
if UserName[1] == "مطور" then
if not msg.DevelopersQ then
...
if Redis:sismember(Saidi.."L_U_2:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✠ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."L_U_2:Groups")
Redis:sadd(Saidi.."L_U_2:Groups", Message_Reply.sender.user_id)
Redis:set(Saidi.."id:L_U_2:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(Saidi.."L_U_2:Groups",UserId) then
...
local L_U_2 = LuaTele.getUser(v)
if L_U_2 and L_U_2.username and L_U_2.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..L_U_2.username.."](tg://user?id="..v..")\n"
else
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد المتوحدين في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه المتوحدين ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼• 𝗦𝗢𝗨𝗥𝗖𝗘 𓅛𝗟𝗘𝗔𝗗𝗘𝗥 •𓄹', url = "http://t.me/LEDARQ"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد كلاب في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه الكلاب ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد قرود في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه القرود ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد بقرات في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه البقرات ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوحد ارمله في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه الارمله ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد خولات في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه الخولات ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد حمير في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه الحمير ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد موزه في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه المزز ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد الوتكات في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه الوتكات ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد ابنك في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه أولادك ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد بنتك في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه بناتك ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*✠ لا يوجد خاين في الكروب *","md",true)  
end
ListMembers = '\n*✠ قائمه الخاينين ⇧⇩\n ⩹┉┉┉┉⊶❲𖥳 𝗟𝗘𝗔𝗗𝗘𝗥 𖥳❳⊷┉┉┉┉⩺*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(Saidi.."L_U_2:Groups") 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼• مسح المحظورين عام •𓄹', data = msg.sender.user_id..'/L_U_2All'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(Saidi.."L_U_2:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼• مسح المحظورين •𓄹', data = msg.sender.user_id..'/L_U_2Group'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
Redis:set(Saidi.."L_U_2:Jeka"..msg_chat_id,true) 
...
if TextMsg == 'ردود السورس' then
Redis:del(Saidi.."L_U_2:Jeka"..msg_chat_id) 
...
local L_U_2a = LuaTele.searchPublicChat(UserName)
if not L_U_2a.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✠ عذرا لا يوجد حساب بهاذا المعرف ","md",true)  
end
if L_U_2a.type.is_channel == true then
...
if Controller(msg_chat_id,L_U_2a.id) == 'المطور الاساسي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✠ عذرا لا تستطيع استخدام الامر على〘 "..Controller(msg_chat_id,L_U_2a.id).." 〙*","md",true)  
end
if StatusCanOrNotCan(msg_chat_id,L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✠ عذرا لا تستطيع استخدام الامر على〘 "..Controller(msg_chat_id,L_U_2a.id).." 〙*","md",true)  
end
if Redis:sismember(Saidi.."BanAll:Groups",L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."BanAll:Groups",L_U_2a.id) 
LuaTele.setChatMemberStatus(msg.chat_id,L_U_2a.id,'L_U_2ned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم حظره عام من المجموعات ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Saidi.."BanAll:Groups",L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."BanAll:Groups",L_U_2a.id) 
LuaTele.setChatMemberStatus(msg.chat_id,L_U_2a.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
if Redis:sismember(Saidi.."ktmAll:Groups",L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."ktmAll:Groups",L_U_2a.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم كتمه عام من المجموعات ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Saidi.."ktmAll:Groups",L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."ktmAll:Groups",L_U_2a.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
if GetInfoBot(msg).L_U_2User == false then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ البوت ليس لديه صلاحيه حظر المستخدمين* ',"md",true)  
end
if not msg.Originators and not Redis:get(Saidi.."Status:L_U_2Id"..msg_chat_id) then
...
if Redis:sismember(Saidi.."L_U_2Group:Group"..msg_chat_id,L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."L_U_2Group:Group"..msg_chat_id,L_U_2a.id) 
LuaTele.setChatMemberStatus(msg.chat_id,L_U_2a.id,'L_U_2ned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم حظره من الكروب ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Saidi.."L_U_2Group:Group"..msg_chat_id,L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."L_U_2Group:Group"..msg_chat_id,L_U_2a.id) 
LuaTele.setChatMemberStatus(msg.chat_id,L_U_2a.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم الغاء حظره من الكروب  ").Reply,"md",true)  
end
end
...
if StatusSilent(msg_chat_id,L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✠ عذرا لا تستطيع استخدام الامر على〘 "..Controller(msg_chat_id,L_U_2a.id).." 〙*","md",true)  
end
if Redis:sismember(Saidi.."SilentGroup:Group"..msg_chat_id,L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم كتمه في الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."SilentGroup:Group"..msg_chat_id,L_U_2a.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم كتمه في الكروب  ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Saidi.."SilentGroup:Group"..msg_chat_id,L_U_2a.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(Saidi.."SilentGroup:Group"..msg_chat_id,L_U_2a.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
local L_U_2a = LuaTele.searchPublicChat(UserName[3])
if not L_U_2a.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✠ عذرا لا يوجد حساب بهاذا المعرف ","md",true)  
end
if L_U_2a.type.is_channel == true then
...
LuaTele.setChatMemberStatus(msg.chat_id,L_U_2a.id,'restricted',{1,0,0,0,0,0,0,0,0,tonumber(msg.date+Time)})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم تقييده في الكروب \n ✠ لمدة : "..UserName[1]..' '..UserName[2]).Reply,"md",true)  
end
...
local L_U_2 = LuaTele.getUser(UserId[3])
if L_U_2.luatele == "error" and L_U_2.code == 6 then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✠ عذرا لا تستطيع استخدام ايدي خطأ ","md",true)  
end
...
LuaTele.setChatMemberStatus(msg.chat_id,L_U_2a.id,'restricted',{1,0,0,0,0,0,0,0,0})
if L_U_2.first_name then
L_U_2iusername = '*المستخدم -› *['..L_U_2a.first_name..'](tg://user?id='..L_U_2a.id..' 〙*\n ✠ تم تقييده في الكروب\nمن قبل -› *['..bain.first_name..'](tg://user?id='..bain.id..' 〙*\n*'
else
L_U_2iusername = 'لا يوجد'
end
keyboard = {} 
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/apqiy/89&caption=".. URL.escape(L_U_2iusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
LuaTele.setChatMemberStatus(msg.chat_id,L_U_2a.id,'restricted',{1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(L_U_2a.id," ✠ تم الغاء تقييده من الكروب").Reply,"md",true)  
end
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').."احظرو عام" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." حظر عام" or text == 'حظر عام' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'L_U_2ned',0)
if L_U_2.first_name then
L_U_2iusername = '*الـعـضـو -› *['..L_U_2.first_name..'](tg://user?id='..L_U_2.id..' 〙*\n ✠ تـم حـظـره عـام مـن الـمـجـمـوعـات\nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..' 〙*\n*'
else
L_U_2iusername = 'لا يوجد'
end
keyboard = {} 
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/apqiy/105&caption=".. URL.escape(L_U_2iusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." الغاء حظر عام" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." الغاء الحظر عام" or text == "الغاء حظر عام" or text == 'الغاء الحظر عام' and msg.reply_to_message_id ~= 0 then
if not msg.DevelopersQ then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(2)..' 〙* ',"md",true)  
end
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." اكتمو عام" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." كتم عام" or text == ('كتم عام') and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." الغاء الكتم العام" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').."الغاء كتم العام" or text == 'الغاء كتم العام' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." احظرو" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').."حظر" or text == 'حظر' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."L_U_2Group:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Saidi.."L_U_2Group:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'L_U_2ned',0)
if L_U_2.first_name then
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." الغاء الحظر" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." الغاء حظر" or text == 'الغاء حظر' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if not Redis:sismember(Saidi.."L_U_2Group:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Saidi.."L_U_2Group:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." اكتمو" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." كتم" or text == 'كتم' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." الغاء الكتم" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." الغاء كتم" or text == 'الغاء كتم' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." تقيد" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." تقييد" or text == 'تقييد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/apqiy/104&caption=".. URL.escape(L_U_2iusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').."الغاء التقيد" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." الغاء التقييد" or text == 'الغاء التقييد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." اطرد ده" or text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." طرد" or text == 'طرد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✠ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if UserId == "1696907808" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✠ عذرا لا تستطيع استخدام الامر على المطور حسون *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✠ تم طردك من الكروب بنائا على طلبك").Reply,"md",true)  
end
...
local L_U_2 = LuaTele.getUser(v.member_id.user_id)
if L_U_2.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @LEDARQ"..Creator.."\n"
else
listAdmin = listAdmin.."*"..k.." - *["..L_U_2.id.."](tg://user?id="..L_U_2.id..") "..Creator.."\n"
end
end
...
local photo = LuaTele.getUserProfilePhotos( L_U_2.id)
...
if L_U_2.username then
Creator = "* "..L_U_2.first_name.."*\n"
else
Creator = "* ["..L_U_2.first_name.."](tg://user?id="..L_U_2.id..")*\n"
end
if L_U_2.first_name then
Creat = " "..L_U_2.first_name.." "
else
Creat = " Developers Bot \n"
end
if photo.total_count > 0 then
local TestText = "*𓄼• ِٰ𝗢ِٰ𝗪ِٰ𝗡ِٰ𝗘ِٰ𝗥ِٰ  ِٰ𝗚ِٰ𝗥ِٰ𝗢ِٰ𝗨ِٰ𝗣ِٰ𝗦ِٰ  -› *  ["..L_U_2.first_name.."](tg://user?id="..L_U_2.id..")\n*𓄼• ʙɪᴏ -› * [〘 "..Bio.." 〙]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..L_U_2.username..""},
},
}
...
local  L_U_2 = LuaTele.getUser(Sudo_Id) 
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
if photo.total_count > 0 then
local TestText = "*𓄼• ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙᴏᴛ •𓄹*\n*𓄼• ɴᴀᴍᴇ -› *  ["..L_U_2.first_name.."](tg://user?id="..Sudo_Id..")\n*𓄼• ʙɪᴏ -› * ["..Bio.." ]\n"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..L_U_2.username..""},
...
local id = Redis:get(Saidi.."id:L_U_2:Groups")
urrl = https.request('http://api.telegram.org/bot'..Token..'/getchat?chat_id='..id)
local L_U_2yt = JSON.decode(urrl)
local bains = LuaTele.getUser(L_U_2yt)
local name = ' '..L_U_2yt.result.first_name..' '
if L_U_2yt.result.username then
apapiy = ' '..L_U_2yt.result.username..' '
else
apapiy = 'LEDARQ'
end
if L_U_2yt.result.first_name then
klajq = ' '..L_U_2yt.result.first_name..' '
else
klajq = 'لا يوجد'
end
local abnj = " \n*𓄼• ɴᴀᴍᴇ -› * "..L_U_2yt.result.first_name.." \n"
keyL_U_2yt = {} 
keyL_U_2yt.inline_keyboard = {
{
{text = name, url = "https://t.me/"..L_U_2yt.result.username..""},
},
}
local msg_id = msg.id/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&reply_to_message_id="..msg_id.."&photo=t.me/"..L_U_2yt.result.username.."&caption="..URL.escape(abnj).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyL_U_2yt))
local TestT = " \n*𓄼• ɴᴀᴍᴇ -› * "..L_U_2yt.result.first_name.." \n"
keyboardd = {} 
keyL_U_2yt.inline_keyboard = {
{
...
listBots = listBots.."*"..k.." - @"..L_U_2.username.."* "..Admin.."\n"
end
...
local L_U_2 = LuaTele.getUser(v.member_id.user_id)
if L_U_2.username ~= "" then
restricted = restricted.."*"..x.." - @"..L_U_2.username.."*\n"
else
restricted = restricted.."*"..x.." - *["..L_U_2.id.."](tg://user?id="..L_U_2.id..") \n"
end
end
end
if y == true then
...
if Redis:get(Saidi.."Status:L_U_2"..msg.chat_id)  then
StatusL_U_2Id = '【 ✅ 】' else StatusL_U_2Id = '【 ❌ 】'
end
...
data = {
{
{text = '𓄼• 𝗦𝗢𝗨𝗥𝗖𝗘 𓅛𝗟𝗘𝗔𝗗𝗘𝗥 •??', url = 't.me/LEDARQ'}, 
},
}
}
...
Redis:del(Saidi.."L_U_2:Group"..msg_chat_id) 
...
local Info_Members = LuaTele.getSupergroupMembers(msg_chat_id, "L_U_2ned", "*", 0, 200)
x = 0
local List_Members = Info_Members.members
for k, v in pairs(List_Members) do
UNL_U_2_Bots = LuaTele.setChatMemberStatus(msg.chat_id,v.member_id.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
if UNL_U_2_Bots.luatele == "ok" then
x = x + 1
end
end
...
for k, v in pairs(List_Members) do
local L_U_2 = LuaTele.getUser(v.member_id.user_id)
if L_U_2.type.luatele == "userTypeDeleted" then
local userTypeDeleted = LuaTele.setChatMemberStatus(msg.chat_id,v.member_id.user_id,'L_U_2ned',0)
...
LuaTele.sendText(msg_chat_id,msg_id,[[*
✠ ارسل اذاعتك لتثبيت في الكروبات 
...
LuaTele.sendText(msg_chat_id,msg_id,[[*
✠ ارسل اذاعتك لنشرها في الكروبات 
 ✠ للخروج من الامر ارسل 〘الغاء〙
*]],"md",true)  
return false
end
...
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).L_U_2All == true then
L_U_2All = '✠ محظور عام'
else
L_U_2All = '✠ غير محظور عام'
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).L_U_2Group == true then
L_U_2Group = '✠ محظور'
else
L_U_2Group = '✠ غير محظور'
end
...
if Statusrestricted(msg_chat_id,UserId_Info.id).L_U_2All == true then
L_U_2All = '✠ محظور عام'
else
L_U_2All = '✠ غير محظور عام'
end
if Statusrestricted(msg_chat_id,UserId_Info.id).L_U_2Group == true then
L_U_2Group = '✠ محظور'
else
L_U_2Group = '✠ غير محظور'
end
...
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).L_U_2All == true and msg.ControllerBot then
L_U_2All = '✠ محظور عام'
Redis:srem(Saidi.."L_U_2:Groups",Message_Reply.sender.user_id) 
else
L_U_2All = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).L_U_2Group == true then
L_U_2Group = '✠ محظور'
Redis:srem(Saidi.."L_U_2:Group"..msg_chat_id,Message_Reply.sender.user_id) 
else
L_U_2Group = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).SilentGroup == true then
...
LuaTele.sendText(msg_chat_id,msg_id,"\n* ✠ تم رفع القيود عنه -› 〘 "..L_U_2All..L_U_2Group..SilentGroup..Restricted..' 〙*',"md",true)  
end
...
if Statusrestricted(msg_chat_id,UserId_Info.id).L_U_2All == true and msg.ControllerBot then
L_U_2All = '✠ محظور عام'
Redis:srem(Saidi.."L_U_2:Groups",UserId_Info.id) 
else
L_U_2All = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).L_U_2Group == true then
L_U_2Group = '✠ محظور'
Redis:srem(Saidi.."L_U_2:Group"..msg_chat_id,UserId_Info.id) 
else
L_U_2Group = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).SilentGroup == true then
...
data.inline_keyboard = {
{
{text ='نسبه جمالك يا قمر '..rdbhoto..' 🌝🖤',url = "https://t.me/"..L_U_2.username..""}, 
},
}
local msgg = msg_id/2097152/0.5
...
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local L_U_2 = LuaTele.getUser(msg.sender.user_id)
local L_U_2_ns = 'ʜᴇʀᴇ ᴀʀᴇ ʏᴏᴜʀ ᴘʜᴏᴛᴏѕ'
if photo.total_count > 0 then
data = {} 
data.inline_keyboard = {
{
{text = '𓄼• اخفاء الامر •𓄹', callback_data = msg.sender.user_id..'/L_U_288'}, 
},
{
{text = '▾ صورتك القادمه ▴', callback_data= msg.sender.user_id..'/L_U_21'}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(L_U_2_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
...
{
{text = '𓄼• 𝗦𝗢𝗨𝗥𝗖𝗘 𓅛𝗟𝗘𝗔𝗗𝗘𝗥 •𓄹', url = "http://t.me/LEDARQ"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/faioo8/'..Saidi..'&caption=' .. URL.escape(L_U_2iusername).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
local Mostafa = (Redis:get(Saidi.."Name:Bot") or "ليدر")
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
local RinkBot = msg.Name_Controller
photo = "http://t.me/LEDARQ"
local Name = '*𓄼• ᴡᴇʟᴄᴏᴍᴇ ʏᴀ->* ['..RinkBot..'](tg://user?id='..user_info.id..')\n*𓄼• ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ 𝗦𝗢𝗨𝗥𝗖𝗘 𓅛𝗟𝗘𝗔𝗗𝗘𝗥*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• ℍ𝔸𝕊𝕊𝕆ℕ➪🇳🇱•𓄹', url = "https://t.me/L_U_2"}
},
{
{text = '𓄼• 𝗦𝗢𝗨𝗥𝗖𝗘 𓅛𝗟𝗘𝗔𝗗𝗘𝗥 •𓄹', url = "http://t.me/LEDARQ"}
},
...
if text == 'حسون' or text == 'المطور حسون' or text == 'مطور السورس' then
photo = "https://t.me/L_U_2"
local Name = '*المطور حسون مطور السورس لو حاابب تتواصل معاه بالاسفل ⬇️*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• ℍ𝔸𝕊𝕊𝕆ℕ➪🇳🇱•𓄹', url = "https://t.me/L_U_2"}
...
{
{text = '𓄼• 𝗦𝗢𝗨𝗥𝗖𝗘 𓅛𝗟𝗘𝗔𝗗𝗘𝗥 •𓄹', url = 't.me/LEDARQ'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
return LuaTele.sendText(msg_chat_id,msg_id,' ✠ اليك قسم الالعاب من سورس ليدر ',"md",false, false, false, false, reply_markup)
end
...
if not Redis:get(Saidi.."L_U_2:Jeka"..msg_chat_id) then
...
local photo = LuaTele.getUserProfilePhotos(Saidi)
local L_U_2 = LuaTele.getUser(Saidi)
local NamesBot = (Redis:get(Saidi.."Name:Bot") or "ليدر")
local BotName = {
...
local first_n = L_U_2.first_name
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == (Redis:get(Saidi.."Name:Bot") or "ليدر") then
local photo = LuaTele.getUserProfilePhotos(Saidi)
local L_U_2 = LuaTele.getUser(Saidi)
local NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "ليدر")
local BotName = {
'نعم يروحي 🌝💙',
'نعم يا قلب '..NamesBot..'',
'عوز اي مني '..NamesBot..'',
...
if text == (Redis:get(Saidi.."Name:Bot") or 'ليدر').." غادر" or text == 'غادر' or text == 'بوت غادر' then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✠ هاذا الامر يخص 〘 '..Controller_Num(3)..' 〙* ',"md",true)  
end
if not msg.ControllerBot and not Redis:set(Saidi.."Left:L_U_2:Bot") then
...
if L_U_2.first_name then
L_U_2iusername = '*عزيزي -› *['..bain.first_name..'](tg://user?id='..bain.id..')*\nهل تريد بوت -› *['..Mostafa..'](tg://user?id='..L_U_2.id..')*\nان يغادر من المجموعه\n*'
else
L_U_2iusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
...
Redis:set(Saidi.."Game:L_U_2"..msg.chat_id,name)
...
local CmdStart = '*\n ✠ أهلا بك في بوت '..(Redis:get(Saidi.."Name:Bot") or "ليدر")..
...
if not msg.ControllerBot then
if Redis:get(Saidi.."TwaslBot") and not Redis:sismember(Saidi.."L_U_2:In:Tuasl",msg.sender.user_id) then
...
if data.supergroup.status.luatele == "chatMemberStatusL_U_2ned" then
...
{
{text = '𓄼• مسح المكتومين •𓄹', data = IdUser..'/SilentGroupGroup'}, {text = '𓄼• مسح المحظورين •𓄹', data = IdUser..'/L_U_2Group'}, 
},
{
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس ليدر اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس ليدر 
...
local TextHelp = [[*
هــلا بــك في اومــر الـبوت الاساسيه
╗•❶• ‹ اوامر المطورين ›
╣•❷• ‹ اوامر التسليه ›
╣•❸• ‹ اوامر الاعضاء ›
╣•❹• ‹ اوامر المسح ›
...
L_U_2iusername = '*تم الزواج بنجاح \nمبورك يا  -› *['..bain.first_name..'](tg://user?id='..bain.id..' 〙*\n*'
else
L_U_2iusername = 'لا يوجد'
end
LuaTele.editMessageText(ChatId,Msg_id,L_U_2iusername, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Saidi.."L_U_2:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Saidi.."Status:L_U_2"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Saidi.."L_U_2:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Saidi.."Status:L_U_2"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
elseif Text and Text:match('(%d+)/L_U_2Group') then
local UserId = Text:match('(%d+)/L_U_2Group')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Saidi.."L_U_2:Group"..ChatId) 
